...
main.py
-------
The FastAPI application: all HTTP endpoints live here.
...
# ---------------------------------------------------------------------------
# Create the database tables (does nothing if they already exist)
# ---------------------------------------------------------------------------
...
# SERVE THE FRONTEND
# ===========================================================================
# This MUST be mounted last: it takes over the "/" path, and everything
# registered before it (all /api routes plus /docs) keeps working.
